...
cp -i crab_20151027/Run2015D-PromptReco-v3/res/ntuple_* $path/$date/Data
cp crab_20151027/DYJetsToLL/res/ntuple_* $path/$date/DYJetsToLL
cp crab_20151027/TTJets/res/ntuple_* $path/$date/TTJets
cp crab_20151027/WJetsToLNu/res/ntuple_* $path/$date/WJetsToLNu
